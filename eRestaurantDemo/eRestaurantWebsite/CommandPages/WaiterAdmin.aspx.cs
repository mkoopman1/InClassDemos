...
using Microsoft.AspNet.Identity;//manually inputted- needed for GetUserName()- which is an extension method
#endregion
...
public partial class CommandPages_WaiterAdmin : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            //check to see if the current user requestor is logged in
            //if not, send the current user to the log in page
