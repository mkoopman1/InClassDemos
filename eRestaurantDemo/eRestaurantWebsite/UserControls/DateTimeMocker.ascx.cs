...
{
    //create properties that will allow external users of this control to have access to the data 
    ...
    public DateTime MockDate 
    {
        get
        {
            ...
            //possibly override the default date with the contents of the web control Search date
    ...
    public TimeSpan MockTime
    {
        ...
        set
        {
            SearchTime.Text = DateTime.Today.Add(value).ToString("DefaultHttpHandler:mm:ss");
        }
    }
